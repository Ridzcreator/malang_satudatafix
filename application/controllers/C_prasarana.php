...
class C_prasarana extends CI_Controller {
    ...
    public function index() {
      ...
      $data['datad']=$this->m_prasarana->tampil_desaku();
  ...
  public function proses_input_detail_prasarana(){
    $page = $this->uri->segment(3); 
      $kec=$this->input->post('kecamatan');
      $where = array('id_kecamatan' => $kec);
      $kecamatan_arr = $this->m_prasarana->getNamaKecamatanWhere($where)->row();
      ...
      $penginput = $this->input->post('penginput');
      $jumlah=$stadion+$spkbola+$voly+$basket+$tenis+$bt+$futsal+$gor+$aula+$kolam;
      $this->m_prasarana->simpan_prasarana($kecamatan,$desa,$stadion,$spkbola,$voly,$basket,$tenis,$bt,$futsal,$gor,$aula,$kolam,$jumlah,$tahun,$penginput);

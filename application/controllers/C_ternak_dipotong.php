...
class C_ternak_dipotong extends CI_Controller {
    ...
    public function tampil_detail_ternak_dipotong(){
        ...
        $data['datas']=$this->m_ternak_dipotong->tampil_kecamatan();
        $data['datad']=$this->m_ternak_dipotong->tampil_desaku();
        $data['datax']=$this->m_ternak_dipotong->tampil_tahun();
        $data['datam']=$this->m_ternak_dipotong->master_hewan_ternak();
    ...
    public function tambah_ternak_dipotong(){
        ...
        $kecamatan_arr = $this->m_ternak_dipotong->getNamaKecamatanWhere($where)->row();
        ...
        $this->m_ternak_dipotong->simpan_ternak_dipotong($kecamatan, $desa, $nama_ternak, $jumlah, $tahun, $penginput);
    ...
    public function ubah_ternak_dipotong(){
        ...
        $this->m_ternak_dipotong->ubah_ternak_dipotong($id, $kecamatan, $desa, $nama_ternak, $jumlah, $tahun, $penginput);
    ...
    public function pilih_desa(){
        $data['kelurahan']=$this->m_ternak_dipotong->tampil_desa($this->uri->segment(3));

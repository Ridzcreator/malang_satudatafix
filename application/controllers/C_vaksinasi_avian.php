...
class C_vaksinasi_avian extends CI_Controller {
    ...
    public function get() {
        ...
        foreach ($data['data']->result_array() as $a) {
            ...
            // $desa = $this->m_vaksinasi_avian->getNamaDesaWhere($where)->row()->nama_desa;
            $jumlah=$a['jumlah'];
            $temp[]=$kecamatan;
            // $temp[]=$desa;
    ...
    public function tampil_detail_vaksinasi(){
        ...
        $data['datas']=$this->m_vaksinasi_avian->tampil_kecamatan();
        $data['datad']=$this->m_vaksinasi_avian->tampil_desaku();
        $data['datax']=$this->m_vaksinasi_avian->tampil_tahun();
        $data['datam']=$this->m_vaksinasi_avian->master_hewan_ternak();
    ...
    public function tambah_vaksinasi(){
        ...
        $kecamatan_arr = $this->m_vaksinasi_avian->getNamaKecamatanWhere($where)->row();
        ...
        $this->m_vaksinasi_avian->simpan_vaksinasi($kecamatan, $desa, $nama_ternak, $jumlah, $tahun, $penginput);
    ...
    public function ubah_vaksinasi(){
        ...
        $this->m_vaksinasi_avian->ubah_vaksinasi($id, $kecamatan, $desa, $nama_ternak, $jumlah, $tahun, $penginput);
    ...
    public function pilih_desa(){
        $data['kelurahan']=$this->m_vaksinasi_avian->tampil_desa($this->uri->segment(3));

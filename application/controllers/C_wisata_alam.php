...
class C_wisata_alam extends CI_Controller {
    ...
    public function lihatmaps(){
        ...
        $this->load->view('template/header');
        $this->load->view('pariwisata/v_lihat_maps_alam',$data);
        $this->load->view('template/footer');
    }
    ...
    public function tambah_wisata_alam(){
        ...
        $this->m_wisata_alam->simpan_wisata_alam($nama, $kecamatan, $desa, $latitude, $longitude, $fasilitas, $pengelola, $publikasi, $aksesibilitas, $tenaga_kerja, $penginput, $jenis_warisan);

...
class C_wisata_buatan extends CI_Controller {
    ...
    public function lihatmaps(){
        ...
        foreach ($data['data']->result_array() as $wisata) {
            ...
            array_push($lat, $wisata['latitude']);
            array_push($lng, $wisata['longitude']);
        }
        ...
        $this->load->view('template/header');
        $this->load->view('pariwisata/v_lihat_maps_buatan',$data);
        $this->load->view('template/footer');
    }
    ...
    public function tambah_wibu(){
        ...
        $this->m_wisata_buatan->simpan_wibu($nama, $kecamatan, $desa, $latitude, $longitude, $fasilitas, $deskripsi, $pengelola, $publikasi, $aksesibilitas, $tenaga_kerja, $penginput, $jenis_warisan);

...
class C_wisata_budaya extends CI_Controller {
    ...
    public function lihatmaps(){
        ...
        $this->load->view('template/header');
        $this->load->view('pariwisata/v_lihat_maps_budaya',$data);
        $this->load->view('template/footer');
    }
    ...
    public function tambah_wibu(){
        ...
        $this->m_wisata_budaya->simpan_wibu($nama, $kecamatan, $desa, $latitude, $longitude, $fasilitas, $deskripsi, $pengelola, $publikasi, $aksesibilitas, $penginput, $jenis_warisan);

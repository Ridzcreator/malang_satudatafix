...
class Kec_jamkesmas_donomulyo extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]="<a class=\"btn btn-xs btn-success\" href=\"Kec_jamkesmas_donomulyo/detailkec_jaminan_kesehatan/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
	...
	public function grafik_perbandingan() {
	  ...
	  $tahun23 = $this->input->post('tahun23');
	  $tahun2 = $this->input->post('tahun2');
	  $kecamatan=$this->input->post('kecamatan');
	  $data['datakec']=$kecamatan;
	  if($tahun23>$tahun2){
		list($tahun23, $tahun2) = array($tahun2, $tahun23);
	  }
	  $data['datap']=$datap;
      $data['data']=$this->m_jamkesmas->grafik_perbandingan_kec_jamkesmasx($tahun2, $tahun23, $kecamatan);
      $data['dataz']=$this->m_jamkesmas->tahun_crosstab($kecamatan);
      $data['tahun']=$this->m_jamkesmas->tampil_periodec($tahun23,$tahun2,$kecamatan);
      $data['jumlah']=$this->m_jamkesmas->tampil_jumlahc($tahun23,$tahun2,$kecamatan);
      $data['jumlah23']=$this->m_jamkesmas->tampil_jumlahxc($tahun23,$tahun2,$kecamatan);
	...
	public function tampil_crosstab_kec_jamkesmas(){
      ...
      $data['tahun']=$this->m_jamkesmas->tampil_periodec($tahun23,$tahun2,$kecamatan);
      $data['jumlah']=$this->m_jamkesmas->tampil_jumlahc($tahun23,$tahun2,$kecamatan);
      $data['jumlah1']=$this->m_jamkesmas->tampil_jumlahxc($tahun23,$tahun2,$kecamatan);
      $data['keterangan']=$this->m_jamkesmas->tampil_keteranganc($kecamatan);
        $this->load->view('template/header');
   	...
   	public function proses_input_kec_jamkesmas(){
		...
		redirect('Kec_jamkesmas_donomulyo');   	
	}
	...
	public function proses_input_detailkec_jamkesmas(){
		...
		$alamat="donomulyo";
   		$this->m_jamkesmas->simpan_barang($penginput,$kecamatan,$periode,$ket,$unit,$alamat,$status);
		redirect('Kec_jamkesmas_donomulyo/detailkec_jaminan_kesehatan/'.$page);   	
	}	

...
class Kec_jamkesmas_wajak extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]="<a class=\"btn btn-xs btn-success\" href=\"Kec_jamkesmas_wajak/detailkec_jaminan_kesehatan/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
	...
	public function proses_input_detailkec_jamkesmas(){
		...
		$alamat="wajak";
   		$this->m_jamkesmas->simpan_barang($penginput,$kecamatan,$periode,$ket,$unit,$alamat,$status);
		redirect('Kec_jamkesmas_wajak/detailkec_jaminan_kesehatan/'.$page);   	
	}	

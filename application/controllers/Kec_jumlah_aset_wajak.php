...
class Kec_jumlah_aset_wajak extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_jumlah_aset_wajak/detail_jumlah_aset/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
    ...
    public function tampil_crosstab_jumlah_aset(){
      ...
      $data['keterangan']=$this->M_jumlah_aset->tampil_keteranganc();
   	...
   	public function proses_input_jumlah_aset(){
		...
		redirect('Kec_jumlah_aset_wajak');   	
	}
	...
	public function proses_input_detail_jumlah_aset(){
		...
		$value2 = $this->input->post('nominal');
   		$this->M_jumlah_aset->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$value2,$alamat);
		redirect('Kec_jumlah_aset_wajak/detail_jumlah_aset/'.$page);   
	}

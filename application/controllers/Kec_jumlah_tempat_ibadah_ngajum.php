...
class Kec_jumlah_tempat_ibadah_ngajum extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_jumlah_tempat_ibadah_ngajum/detail_jumlah_tempat_ibadah/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
    ...
    public function tampil_crosstab_jumlah_tempat_ibadah(){
      ...
      $data['keterangan']=$this->M_jumlah_tempat_ibadah->tampil_keteranganc();
   	...
   	public function proses_input_jumlah_tempat_ibadah(){
		...
		redirect('Kec_jumlah_tempat_ibadah_ngajum');   	
	}
	...
	public function proses_input_detail_jumlah_tempat_ibadah(){
		...
		$value1 = $this->input->post('jumlah');
   		$this->M_jumlah_tempat_ibadah->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$alamat);
		redirect('Kec_jumlah_tempat_ibadah_ngajum/detail_jumlah_tempat_ibadah/'.$page);   
	}

...
class Kec_banyak_lapangan_olahraga_jabung extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]="<a class=\"btn btn-xs btn-success\" href=\"Kec_banyak_lapangan_olahraga_jabung/detailkec_banyak_lapangan_olahraga/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
	...
	public function tampil_crosstab_kec_banyak_lapangan_olahraga(){
      ...
      $data['keterangan']=$this->m_banyak_lapangan_olahraga->tampil_keteranganc();
   	...
   	public function proses_input_kec_banyak_lapangan_olahraga(){
		...
		redirect('Kec_banyak_lapangan_olahraga_jabung');   	
	}

...
class Kec_jamkesmas_wonosari extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]="<a class=\"btn btn-xs btn-success\" href=\"Kec_jamkesmas_wonosari/detailkec_jaminan_kesehatan/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
	...
	public function tampil_crosstab_kec_jamkesmas(){
      ...
      $data['keterangan']=$this->m_jamkesmas->tampil_keteranganc($kecamatan);
   	...
   	public function proses_input_kec_jamkesmas(){
		...
		redirect('Kec_jamkesmas_wonosari');   	
	}
	...
	public function proses_input_detailkec_jamkesmas(){
		...
		$alamat="wonosari";
   		$this->m_jamkesmas->simpan_barang($penginput,$kecamatan,$periode,$ket,$unit,$alamat,$status);
		redirect('Kec_jamkesmas_wonosari/detailkec_jaminan_kesehatan/'.$page);   	
	}	

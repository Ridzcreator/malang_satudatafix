...
class Kec_jumlah_aset_dihapus_gedangan extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_jumlah_aset_dihapus_gedangan/detail_jumlah_aset_dihapus/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
	 ...
	 public function grafik_perbandingan() {
      ...
      if($grafikp=="bar"){
   	...
   	public function proses_input_jumlah_aset_dihapus(){
		...
		redirect('Kec_jumlah_aset_dihapus_gedangan');   	
	}
	...
	public function proses_input_detail_jumlah_aset_dihapus(){
		...
		$value2 = $this->input->post('nominal');
   		$this->M_jumlah_aset_dihapus->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$value2,$alamat);
		redirect('Kec_jumlah_aset_dihapus_gedangan/detail_jumlah_aset_dihapus/'.$page);   
	}

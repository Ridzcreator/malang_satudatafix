...
class Kec_jumlah_jenis_pelayanan_karangploso extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_jumlah_jenis_pelayanan_karangploso/detail_jumlah_jenis_pelayanan/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
    ...
    public function tampil_crosstab_jumlah_jenis_pelayanan(){
      ...
      $data['keterangan']=$this->M_jumlah_jenis_pelayanan->tampil_keteranganc();
   	...
   	public function proses_input_jumlah_jenis_pelayanan(){
		...
		redirect('Kec_jumlah_jenis_pelayanan_karangploso');   	
	}
	...
	public function proses_input_detail_jumlah_jenis_pelayanan(){
		...
		$value1 = $this->input->post('jumlah');
   		$this->M_jumlah_jenis_pelayanan->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$alamat);
		redirect('Kec_jumlah_jenis_pelayanan_karangploso/detail_jumlah_jenis_pelayanan/'.$page);   
	}

...
class Kec_penduduk_berdasarkan_agama_ngantang extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_penduduk_berdasarkan_agama_ngantang/detail_jumlah_penduduk_agama/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a>";
						$tabel[]=$temp;
					}
    ...
    public function tampil_crosstab_penduduk_berdasarkan_agama(){
      ...
      $data['keterangan']=$this->M_penduduk_berdasarkan_agama->tampil_keteranganc();
   	...
   	public function proses_input_jumlah_penduduk_agama(){
		...
		redirect('Kec_penduduk_berdasarkan_agama_ngantang');   	
	}
	...
	public function proses_input_detail_jumlah_penduduk_agama(){
		...
		$value1 = $this->input->post('jumlah');
   		$this->M_penduduk_berdasarkan_agama->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$alamat);
		redirect('Kec_penduduk_berdasarkan_agama_ngantang/detail_jumlah_penduduk_agama/'.$page);   
	}

...
class Kec_wisata_lokal_bululawang extends CI_Controller {
	...
	public function get() {
		...
		$tabel=array();
					...
					$temp = array();
						...
						$temp[]=$periode;
						$temp[]="
						<a class=\"btn btn-xs btn-success\" href=\"Kec_wisata_lokal_bululawang/detail_wisata_lokal/$periode\" title=\"Detail\"><span class=\"fa fa-edit\"></span> Detail</a> |
	 ...
	 public function grafik_perbandingan() {
      ...
      if($datap=="all"){
   	...
   	public function proses_input_wisata_lokal(){
		...
		redirect('Kec_wisata_lokal_bululawang');   	
	}
	...
	public function proses_input_detail_wisata_lokal(){
		...
		$value3 = $this->input->post('value3');
   		$this->M_wisata_lokal->simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$value2,$value3,$alamat);
		redirect('Kec_wisata_lokal_bululawang/detail_wisata_lokal/'.$page);   
	}

<?php
class m_donomulyo_struktur_pemerintahan extends CI_Model {
	...
	public function simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$value2,$value3){
		...
		redirect('donomulyo_struktur_pemerintahan','refresh');
	}
	public function tampil_donomulyo_struktur_pemerintahan($tahun){
		$thn=$tahun;
		if($thn=='0000'){
	...
	public function tampil_donomulyo_struktur_pemerintahanx($id){
	...
	public function grafik_perbandingan_donomulyo_struktur_pemerintahanx($tahun2, $tahun1, $kecamatan){
	...
	function update_donomulyo_struktur_pemerintahan($id,$penginput,$periode,$kecamatan,$value,$value1,$value2,$value3){
	...
	function delete_donomulyo_struktur_pemerintahan($id){
		$status=1;

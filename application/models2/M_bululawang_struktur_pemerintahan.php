<?php
class m_bululawang_struktur_pemerintahan extends CI_Model {
	...
	public function simpan_barang($penginput,$periode,$kecamatan,$value,$value1,$value2,$value3){
		...
		redirect('bululawang_struktur_pemerintahan','refresh');
	}
	public function tampil_bululawang_struktur_pemerintahan($tahun){
		$thn=$tahun;
		if($thn=='0000'){
		$hsl=$this->db->query("SELECT * from kec_struktur_pemerintahan where status='0' and kecamatan='10'");
		}else{
		$hsl=$this->db->query("SELECT * from kec_struktur_pemerintahan where status='0' and periode='$tahun' and kecamatan='10'");	
		}
		return $hsl;  
	}
	public function tampil_tahun(){
		$hsl=$this->db->query("SELECT * from kec_struktur_pemerintahan where status='0' and kecamatan='10' order by periode desc");
		return $hsl;  
	}
	public function tampil_bululawang_struktur_pemerintahanx($id){
	...
	public function grafik_perbandingan_bululawang_struktur_pemerintahanx($tahun2, $tahun1, $kecamatan){
	...
	function update_bululawang_struktur_pemerintahan($id,$penginput,$periode,$kecamatan,$value,$value1,$value2,$value3){
	...
	function delete_bululawang_struktur_pemerintahan($id){
		$status=1;

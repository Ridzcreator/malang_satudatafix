...
class m_wisatawan_menginap extends CI_Model
{
	...
	public function tampil_produksi_daging($id){
		$hasil=$this->db->query("SELECT * FROM produksi_daging_susu WHERE status='0' AND tipe_produksi='produksi_daging'");
		return $hasil;
	}	
	...
	// 	$hsl=$this->db->query("SELECT * FROM detail_wisatawan where status='0' and tahun='$tahun'");	
	// 	return $hsl;  
	// }

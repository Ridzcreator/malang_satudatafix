...
<div class="content-wrapper">
    ...
    <div class="box">
        ...
        <table class="table table-bordered table-striped compact cell-border" style=" font-size:15px; width:100%; text-align:center"   id="tampilDetailKorban">
                <thead>
                    <tr>
                        <th style="text-align:center;width:1%;vertical-align:middle" rowspan="2">No</th>             
                        <th style=" text-align:center;width:15%;vertical-align:middle" rowspan="2">Jenis Korban</th>
                        ...
                        <th style="width:10%;text-align:center;vertical-align:middle" rowspan="2">Periode</th>
                ...
                foreach ($data->result_array() as $a) :
                        ...
                        $periode=$a['periode'];
                         ...
                         <tr>
                        <td><?php echo $no;?></td>
                        <td style="text-align:left;"><?php echo $jeniskorban;?></td>
                        <td><?php echo $nol;?></td>
                        <td><?php echo $sepuluh;?></td>
                        <td><?php echo $duapuluh;?></td>
                        <td><?php echo $tigalima;?></td>
    ...
    <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('jeniskorban/proses_edit_detail_jenis/'.$this->uri->segment(3)) ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('jeniskorban/proses_delete_detail_jenis/'.$this->uri->segment(3)) ?>
            <div class="modal-body">
...
<?php } ?> 
       ...
       <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('jeniskorban/proses_input_detail_jenis/'.$this->uri->segment(3)) ?>
                    ...
                    <table>
                        <tr>
                            <td><label>Periode</label></td><td>:</td>
                            <td>
                            <input name="periode" type="text" value="<?php echo $this->uri->segment(3); ?>" id="periode" class="form-control">
                           </td>
                        </tr>
                        <tr>
                            <td><label>Jenis Korban</label></td><td>:</td>
     ...
     <div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Jeniskorban/grafik_jenis') ?>
                    <div class="modal-body">
                    <table>
                        <tr>
     ...
     <a class="btn btn-s btn-primary" style=" margin-left: 1em; margin-top: 1em; margin-right: 1em; margin-bottom: 0.5em;display:inline-block;" href="<?= base_url('JenisKorban'); ?>">Back</a>
    </div><!-- /.box -->
    </section>
    <!-- /.content -->

...
<div class="content-wrapper">
    ...
    title: {
        text: 'Grafik Perbandingan Jumlah Mobil Pemadam Kebakaran Lokasi Pendopo Malang di Kabupaten Malang'
    },
    subtitle: {
    ...
    xAxis: {
        categories: [<?php $arrlength = count($periodee);
                ...
                echo json_encode($lokasi[$x].'('. $periodee[$x].')');
                if($x < $arrlength-1){
                echo ",";
                }
                }?>],

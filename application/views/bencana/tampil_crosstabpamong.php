...
<div class="content-wrapper">
    ...
    <div class="box">
        ...
        <table class="table table-bordered table-striped compact cell-border" style="font-size:15px; width:100%; text-align:center; " id="tampilDetailCrosstabPamong">
                <thead>
                   <tr>
                 <th rowspan="2" style="text-align: center; padding-bottom: 20px;">Jenis Kelamin</th>

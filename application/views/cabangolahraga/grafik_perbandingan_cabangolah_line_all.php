...
<?php
if($datap=="all"){
    $page="Seluruh Data Jumlah Atlet Berprestasi";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah  Atlet Berprestasi di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('C_cabangolah'); ?>">Jumlah Atlet Berprestasi  di Kabupaten Malang</a></li>
		    ...
		    <?php
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="all"){
                            $value[]=intval($a['prestasi']);
                            $value1[]=intval($a['dibina']);
                        }
            ?>
    ...
    title: {
        text: 'Grafik Perbandingan Data Jumlah Atlet Berprestasi di Kabupaten Malang'
    },
    subtitle: {

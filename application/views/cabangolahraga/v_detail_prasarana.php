    ...
    <?php $page = $this->uri->segment(3);  ?>
        ...
        <td>
            <a class="btn btn-success" href="../grafikdetailprasarana/<?php echo $ex = $this->uri->segment(3);?>">Lihat Grafik</a>
                    ...
                    $desa = $this->m_prasarana->getNamaDesaWhere($where)->row()->nama_desa;
                    $tahun=$a['tahun'];
                    $stadion=$a['stadion'];
                    $spkbola=$a['sb'];
                    $voly=$a['bv'];
            ...
            <div class="modal-body">
                ...
                <table width="90%">
                    ...
                    <tr>
                        ...
                        <td style="padding:  10px"><input name="desa" class="form-control" value="<?php echo $desa;?>" required readonly></td>
                    </tr>
                    <tr>
                        <td style="padding:  10px"><label>Stadion</label></td><td>:</td>

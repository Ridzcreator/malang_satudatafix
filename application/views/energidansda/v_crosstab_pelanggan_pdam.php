...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Pelanggan PDAM</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Crosstab Pelanggan PDAM Menurut Kecamatan Di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        foreach ($bulan->result_array() as $row2) {
            ...
            array_push($array_bulan, $row2['kecamatan']);
        }

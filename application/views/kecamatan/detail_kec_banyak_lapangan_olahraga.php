...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Data Banyak Lapangan Olahraga<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url($idx); ?>">Banyak Lapangan Olahraga</a></li>
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Data Banyak Lapangan Olahraga di Kabupaten Malang  <b><?php echo $ex = $this->uri->segment(3);?></b> </h3>			
        </div>
		...
		<tr>
			...
			<td>
			<a class="btn btn-success" href="../grafikkec_banyak_lapangan_olahraga/<?php echo $ex = $this->uri->segment(3);?>">Lihat Grafik</a>
			</td>
		</tr>
		</table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Data Banyak Lapangan Olahraga</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_edit_detailkec_banyak_lapangan_olahraga/'.$periode) ?>

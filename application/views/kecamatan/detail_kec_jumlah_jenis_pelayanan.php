...
<div class="content-wrapper">
   ...
   <section class="content-header">
        <h1>
            <b>JUMLAH JENIS PELAYANAN<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i>Jumlah Jenis Pelayanan</a></li>
            <li class="active">Detail Jenis Pelayanan Tahun</li> <b><?php echo $periodee; ?></b>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Detail Tabel Jumlah Jenis Pelayanan di Kabupaten Malang</h3>
        </div>
       ...
       <table>
        <tr>
            ...
            <td>
                 <a class="btn btn-success" href="../grafik_jumlah_jenis_pelayanan/<?php echo $periodee?>">Lihat Grafik</a>
            </td>
        </tr>
        </table>
       </table>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;width:60%;vertical-align:middle;">pelayanan</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Jumlah Jenis Pelayanan</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_edit_jumlah_jenis_pelayanan/'.$periodee) ?>
                    ...
                    <table>
                        ...
                        <tr>
                            <td><label>pelayanan</label></td><td>:</td>
                            <td>
							<select name="pelayanan" id="pelayanan" class="form-control" required>
							<option disabled selected value > Pilih pelayanan</option>
							<?php 
							foreach ($dataxs->result_array() as $a){
							$value=$a['id'];
							$pelayanan=$a['keterangan'];
							?><option value="<?php echo $value; ?>" <?php if($value==$valuex){echo "selected";}?>> <?php echo $pelayanan; ?> </option>
							<?php } ?>				
							</select>
							</td>
						</tr>
                        <tr>
                            ...
                            <td><input name="jumlah" class="form-control" type="number" value="<?php echo $value1;?>" placeholder="Jumlah..." style="width:335px;" required></td>
                        </tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart($idx.'/proses_delete_jumlah_jenis_pelayanan') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_detail_jumlah_jenis_pelayanan/'.$periodee) ?>
					...
					<table>
						...
						<tr>
							...
							$value=$a['id'];
							$pelayanan=$a['keterangan'];
							?><option value="<?php echo $value; ?>"> <?php echo $pelayanan; ?> </option>
							<?php } ?>				
							</select>
							</td>
						</tr>

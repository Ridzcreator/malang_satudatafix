...
<div class="content-wrapper">
   ...
   <section class="content-header">
        <h1>
            <b>JUMLAH TEMPAT IBADAH<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i>Jumlah Tempat Ibadah</a></li>
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Detail Tabel Jumlah Tempat Ibadah di Kabupaten Malang</h3>
        </div>
       ...
       <table>
        <tr>
            ...
            <td>
                 <a class="btn btn-success" href="../grafik_jumlah_tempat_ibadah/<?php echo $periodee?>">Lihat Grafik</a>
            </td>
        </tr>
        </table>
       </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Jumlah Tempat Ibadah</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_edit_jumlah_tempat_ibadah/'.$periodee) ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart($idx.'/proses_delete_jumlah_tempat_ibadah') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_detail_jumlah_tempat_ibadah/'.$periodee) ?>

...
<div class="content-wrapper">
   ...
   <section class="content-header">
        <h1>
            <b>JUMLAH PENDUDUK BERDASARKAN AGAMA<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i>Jumlah Penduduk Berdasarkan Agama</a></li>
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Detail Tabel Jumlah Penduduk Berdasarkan Agama di Kabupaten Malang</h3>
        </div>
       ...
       <table>
        <tr>
            ...
            <td>
                 <a class="btn btn-success" href="../grafik_jumlah_penduduk_agama/<?php echo $periodee?>">Lihat Grafik</a>
            </td>
        </tr>
        </table>
       </table>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="text-align:center;width:60%;vertical-align:middle;">Agama</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Jumlah Penduduk Berdasarkan Agama</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_edit_jumlah_penduduk_agama/'.$periodee) ?>
                    ...
                    <table>
                        ...
                        <tr>
							...
							$value=$a['id'];
							$agama=$a['keterangan'];
							?><option value="<?php echo $value; ?>" <?php if($value==$valuex){echo "selected";}?>> <?php echo $agama; ?> </option>
							<?php } ?>				
							</select>
							</td>
						</tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart($idx.'/proses_delete_jumlah_penduduk_agama') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_detail_jumlah_penduduk_agama/'.$periodee) ?>
					...
					<table>
						...
						<tr>
							...
							$value=$a['id'];
							$agama=$a['keterangan'];
							?><option value="<?php echo $value; ?>"> <?php echo $agama; ?> </option>
							<?php } ?>				
							</select>
							</td>
						</tr>

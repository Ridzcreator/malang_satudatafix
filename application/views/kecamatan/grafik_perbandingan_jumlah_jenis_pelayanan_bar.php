...
<body>
<?php
	$page="Jumlah Seluruh Jumlah Jenis Pelayanan Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Jumlah Jenis Pelayanan<b>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Perbandingan Data Jumlah Jenis Pelayanan'
    },
    subtitle: {

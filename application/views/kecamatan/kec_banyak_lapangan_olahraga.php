...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Banyak Lapangan Olahraga <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Banyak Lapangan Olahraga</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
		...
		<div class="box-header">
			<h3 class="box-title">Tabel Banyak Lapangan Olahraga di Kabupaten Malang</h3>
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center;"  id="tampilbanyaklapangan">
                <thead>
                    <tr>
						...
						<th style="text-align:center;width:25%;vertical-align:middle;" >Jumlah Banyak Lapangan Olahraga</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Tambah Data Banyak Lapangan Olahraga</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_input_kec_banyak_lapangan_olahraga') ?>
					...
					<table>
						...
						<tr>
                            <td><label>Jenis Olahraga</label></td><td>:</td>
                            <td>
							<select name="ket" id="ket" class="form-control" required>
							<option disabled selected value > Pilih Jenis Olahraga </option>
							<?php 
	...
	<div id="modalCross" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart(base_url($idx.'/tampil_crosstab_kec_banyak_lapangan_olahraga')) ?>
                    <div class="modal-body">
                    <table>
					<input class="form-control" type="hidden" name="kecamatan" value="<?php echo $hal;?>" style="width:335px;" readonly>

            ...
            <h1>
                <b>JUMLAH PEMBINAAN / SOSIALISASI MASYARAKAT<b>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Jumlah Pembinaan / Sosialisasi Masyarakat</li>
                        </ol>
                        </section>
                        <!-- Main content -->
                        <section class="content">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Tabel Jumlah Pembinaan / Sosialisasi Masyarakat di Kabupaten Malang</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center;"  id="tampiljumlahPembinaan">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center;width:8%;vertical-align:middle;" >Jumlah Pembinaan / Sosialisasi</th>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h3 class="modal-title" id="myModalLabel">Tambah Data Jumlah Pembinaan / Sosialisasi</h3>
                                                </div>
                                                <?php echo form_open_multipart($idx . '/proses_input_jumlah_pembinaan') ?>
							...
							<option value='$i'>$i</option>";
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Terhadap Satuan Perlindungan Masyarakat (Linmas)</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Terhadap Satuan Perlindungan Masyarakat (Linmas)" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosisalisasi Penanggulangan dan Pertolongan Bencana Alam Terhadap Satuan Koordinator Desa (Kordes)</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosisalisasi Penanggulangan dan Pertolongan Bencana Alam Terhadap Satuan Koordinator Desa (Kordes)" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Terhadap Satuan Poskamling</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Terhadap Satuan Poskamling" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Terhadap Keluarga Berencana (KB)</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Terhadap Keluarga Berencana (KB)" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Terhadap Bantuan Sosial</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Terhadap Bantuan Sosial" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Terhadap Penderita Cacat Tuna Karya, Tuna Wisma dan Panti Asuhan</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Terhadap Penderita Cacat Tuna Karya, Tuna Wisma dan Panti Asuhan" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                                        ...
                                                        <tr>
                                                            <td><label>Pembinaan/Sosialisasi Di Tingkat Desa</label></td><td>:</td>
                                                        <input type="hidden" class="form-control" name="jenis_pembinaan[]" value="Pembinaan/Sosialisasi Di Tingkat Desa" required readonly>
                                                        <td>
                                                            <input type="number" class="form-control" name="jumlah[]" placeholder="Jumlah" required></td>
                                        ...
                                        <div id="modalHapus<?php echo $periode ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <?php echo form_open_multipart($idx . '/proses_delete_jumlah_pembinaan/' . $periode) ?>
                                                    <div class="modal-body">
                                    ...
                                    <div id="modalCross" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <?php echo form_open_multipart(base_url($idx . '/tampil_crosstab_jumlah_pembinaan')) ?>
                                                <div class="modal-body">
                                                    <table>
                                                        <input class="form-control" type="hidden" name="kecamatan" value="<?php echo $hal; ?>" style="width:335px;" readonly>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Luas Wilayah</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Tabel Luas Wilayah di Kab. Malang</h3>			
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%;  text-align:center"  id="tampil_luas_wilayah">
                <thead>
                    <tr>
                        <th style="text-align:center;width:1%;">No</th>
						<th style="text-align:center;width:25%;">Luas Wilayah (ha)</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Data Luas Wilayah</h3>
                    </div>
                   <?php echo form_open_multipart($idx.'/proses_edit_luas_wilayah') ?>
					...
					<table>
						...
						<tr>
                            <td><label>Luas Wilayah</label></td><td>:</td>
                            <td><input name="luas_wilayah" class="form-control" type="number" value="<?php echo $value;?>" placeholder="Luas Wilayah..." style="width:335px;" required></td>
						</tr>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Hapus Data</h3>
                  ...
                  <?php echo form_open_multipart($idx.'/proses_delete_luas_wilayah') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_luas_wilayah') ?>
					...
					<table>
						...
						<tr>
                            <td><label>Luas Wilayah</label></td><td>:</td>
                            <td><input name="luas_wilayah" class="form-control" type="number" placeholder="Luas Wilayah" style="width:335px;" required></td>
						</tr>

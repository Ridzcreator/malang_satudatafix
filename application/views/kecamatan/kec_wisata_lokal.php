...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>JUMLAH PENDUDUK WISATA LOKAL<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Jumlah Wisata Lokal</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Tabel Jumlah Wisata Lokal di Kab. Malang</h3>			
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%;  text-align:center"  id="tampil_wisata_lokal">
                <thead>
                    <tr>
                        <th style="text-align:center;width:1%;">No</th>
						<th style="text-align:center;width:10%;">Wisata Alam</th>
						<th style="text-align:center;width:10%;">Wisata Budaya</th>
						<th style="text-align:center;width:10%;">Wisata Edukasi</th>
						<th style="text-align:center;width:10%;">Wisata Budaya</th>
						<th style="text-align:center;width:10%;">Jumlah</th>
						<th style="text-align:center;text-align:center;width:10%;">Periode</th>
                        <th style="text-align:center;width:25%;text-align:center;">Aksi</th>
                    </tr>
                </thead>
                <tbody>
				</tbody>
    ...
    <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_edit_wisata_lokal') ?>
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_wisata_lokal') ?>

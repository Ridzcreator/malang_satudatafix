...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url($idx); ?>">Jumlah Tempat Ibadah</a></li>
            <li class="active"> Crosstab Data Jumlah Tempat Ibadah</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Jumlah Tempat Ibadah Kecamatan <?php echo $kecamatan;?> Tiap Tahun di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>

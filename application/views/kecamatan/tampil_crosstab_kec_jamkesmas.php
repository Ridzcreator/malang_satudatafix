...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Data Banyak Jaminan Kesehatan Masyarakat <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"> Data Jaminan Kesehatan Masyarakat</a></li>
            <li class="active"> Crosstab Data Banyak Jaminan Kesehatan Masyarakat Kecamatan <?php echo $kecamatan;?></li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Penduduk Terfasilitasi Jaminan Kesehatan Masyarakat Kecamatan <?php echo $kecamatan;?> Tiap Tahun di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        foreach ($keterangan->result_array() as $row2) {
            ...
            array_push($array_keterangan, $row2['nama_desa']);
        }
        ...
        array_push($array_data_1, $row4['nama_desa']);
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center;" id="tampil_crosstab_lapangan_olahraga">
                <thead>
                <tr>
                 <th rowspan=2 style="text-align: center; padding-bottom: 20px;">Nama Desa</th>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url($idx); ?>">Jumlah Berdasarkan Agama</a></li>
            <li class="active"> Crosstab Data Jumlah Penduduk Berdasarkan Agama</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Penduduk Berdasarkan Agama Kecamatan <?php echo $kecamatan;?> Tiap Tahun di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center;" id="tampil_crosstab_penduduk_berdasarkan_agama">
                <thead>
                <tr>
                 <th rowspan=2 style="text-align: center; padding-bottom: 20px;">Agama</th>

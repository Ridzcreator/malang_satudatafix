...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('C_kerjasama_media'); ?>">Kerjasama Media</a></li>
            <li class="active">Grafik Bar Data Kerjasama Media</li>
        </ol>
    </section>
    <!-- Main content -->
...
<script type="text/javascript">
    ...
    title: {
        text: 'Grafik Kerjasama Media Tahun <?php echo $tahun ?>'
    },
    subtitle: {

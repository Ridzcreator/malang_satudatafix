<div class="content-wrapper">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Jumlah Lembaga Kemasyarakatan di Kabupaten Malang Tahun <?php echo $ex = $this->uri->segment(3);?></h3>
        </div>
        <div class="box-body">
            <table>
        <tr>
            ...
            <td>
                ...
                ?>
             <a class="btn btn-success" href="<?php echo base_url('LembagaMasyarakat/grafiklembaga/'.$periodei); ?>">Tampil Grafik</a>
            </td>
        </tr>
      
        </table>
        <table class="table table-bordered table-striped compact cell-border" style="font-size:15px;   text-align:center" id="detail_lembaga">
                <thead>
                    <tr>
	 ...
	 <div id="modalInput" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('LembagaMasyarakat/proses_input_detail_lembaga/'.$this->uri->segment(3)) ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="modal-title" id="myModalLabel">Update Data Lembaga Kemasyarakatan</h3>
                    </div>
                    <?php echo form_open_multipart('LembagaMasyarakat/proses_edit_detail_lembaga/'.$this->uri->segment(3)) ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('LembagaMasyarakat/proses_delete_detail_lembaga/'.$this->uri->segment(3)) ?>
            <div class="modal-body">
...
<a class="btn btn-s btn-primary" style=" margin-left: 1em; margin-top: 1em; margin-right: 1em; margin-bottom: 0.5em;display:inline-block;" href="<?= base_url('LembagaMasyarakat'); ?>">Back</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart(base_url('LembagaMasyarakat/tampil_crosstab_masyarakat')) ?>
                    <div class="modal-body">
                    <table>

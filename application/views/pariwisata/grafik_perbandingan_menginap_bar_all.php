...
<?php
if($datap=="all"){
	$page="Seluruh Data Jumlah Wisatawan Menginap";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah Wisatawan Menginap di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url('C_wisatawan_menginap'); ?>">Jumlah Wisatawan Menginap di Kabupaten Malang</a></li>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Grafik Perbandingan Data Jumlah Wisatawan Menginap di Kabupaten Malang'
    },
    subtitle: {

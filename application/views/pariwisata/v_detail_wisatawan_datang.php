...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="box-header">
                    <h4 class="box-title" style="margin-bottom:10px">Detail Wisatawan Datang Ke Kabupaten Malang</h3><br>
                    <?php $page = $this->uri->segment(3);  ?>
                    <td>
                    <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add" style="margin-bottom:10px">Tambah Data <?php echo $page ?></a>
                    </td>
                    <td>
                    <a class="btn btn-primary" href="../tampil_grafik_wisatawan_datang/<?php echo $page ?>" style="margin-bottom:10px">Lihat Grafik</a>
                    </td>
                    <td>
                    <a class="btn btn-success" style="margin-bottom:10px" href="../grafik_datang/<?php echo $ex = $this->uri->segment(3);?>">Lihat Grafik</a>
                    </td>
                </div>
            ...
            <?php $page = $this->uri->segment(3);  ?>
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open_multipart('C_wisatawan/tambah_detail_wisatawan_datang/'.$page) ?>

                        <div class="modal-body">
                            <input class="form-control" type="hidden" name="id" readonly>
                            <input type="hidden" class="form-control" name="jenis_wisatawan" name="id" readonly value="wisatawan_datang">
            ...
            <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                                ...
                                <?php echo form_open_multipart('C_wisatawan/proses_ubah_wisatawan_datang/'.$page) ?>
            ...
            <div id="modalHapus<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3 class="modal-title" id="myModalLabel">Hapus Data Wisatawan Datang</h3>
                        </div>
                        <?php echo form_open_multipart('C_wisatawan/proses_hapus_wisatawan_datang/'.$page) ?>
                        <div class="modal-body">

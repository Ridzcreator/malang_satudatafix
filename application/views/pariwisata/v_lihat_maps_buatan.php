<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Peta Wisata Buatan<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url('C_wisata_buatan'); ?>"></i> Peta Wisata Buatan</a></li>
            <li class="active">Data peta lokasi wisata Buatan di kabupaten malang</li>
        </ol>
    </section>

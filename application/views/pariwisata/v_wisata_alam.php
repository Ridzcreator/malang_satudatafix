               ...
               <!-- /.box-header -->
               		<div class="box-header">
		                ...
		                <tr>
                            ...
                            <td>
                                 <a class="btn btn-success" href="<?php echo base_url(). '/C_wisata_alam/lihatmaps'; ?>">Lihat Maps</a>
                            </td>
		                	<td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><label  >Logitude</label></td>
                                    <td>:</td>
                                    <td><input type="text" class="form-control" style="width:355px" name="longitude" placeholder="logitude" autocomplete="off"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <select name="jenis_warisan" style="width:335px;"  id="jenis_warisan" class="form-control" required>
                ...
                <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 class="modal-title" id="myModalLabel">Ubah Wisata Buatan</h3>
                            </div>
                            ...
                            <div class="modal-body">
                                ...
                                <table>
                                    <tr><td><label >Nama wisata</label></td>
                                        <td>:</td>

                            ...
                            <h4 class="box-title" style="margin-bottom: 10px">Daya Tarik Wisata Buatan Kabupaten Malang</h3><br>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='<?php echo base_url('c_wisata_buatan/maps') ?>' class="btn btn-primary" data-toggle="modal" title="Maps"> Lihat Maps</a>
                                        </td>
                                        <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td><label>Nama Wisata Buatan</label></td>
                                                    <td>:</td>
                                                    <td><input type="text" class="form-control" style="width:355px" name="nama" placeholder="Nama Wisata Buatan" autocomplete="off" required></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><input type="text" class="form-control" style="width:355px" name="lattitude" placeholder="Latitude" autocomplete="off"></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <select name="jenis_wisata" id="jenis_wisata" class="form-control" required>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><label>Longitude</label></td>
                                                        <td>:</td>
                                                        <td><input type="text" class="form-control" name="longitude" style="width:335px;" value="<?php echo $longitude; ?>" autocomplete="off"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label>Latitude</label></td>
                                                        <td>:</td>
                                                        <td><input type="text" class="form-control" name="lattitude" style="width:335px;" value="<?php echo $lattitude; ?>" autocomplete="off"></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label>Alamat</label></td>
                                                        <td>:</td>
                                                        <td><input type="text" class="form-control" name="alamat" style="width:335px;" value="<?php echo $alamat; ?>" autocomplete="off"></td>
                                                    </tr>
                                                    <tr>

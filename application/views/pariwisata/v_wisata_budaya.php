                    ...
                    <h4 class="box-title" style="margin-bottom: 10px">Daya Tarik Wisata Budaya Kabupaten Malang</h3><br>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href='<?php echo base_url('c_wisata_budaya/maps') ?>' data-toggle="modal" title="Add">Lihat Maps</a>
                                </td>
                                <td>
                                ...
                                <div class="modal-body">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><input type="text" class="form-control" style="width:355px" name="latitude" placeholder="Latitude" autocomplete="off"></td>
                                                </tr>
                                        <tr>
                                                    <td><label>Longitude</label></td>
                                                    <td>:</td>
                                                    <td><input type="text" class="form-control" style="width:355px" name="longitude" placeholder="Longitude" autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                                    <td><label>Alamat</label></td>
                                                    <td>:</td>
                                                    <td><input type="text" class="form-control" style="width:355px" name="alamat" placeholder="Alamat" autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><label>Pilih Jenis Wisata</label></td>
                                            <td>:</td>
                                            <td>
                                                <select name="jenis_wisata" style="width:355px" id="jenis_wisata" class="form-control" required>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><input type="text" class="form-control" style="width:355px" name="nama" value="<?php echo $nama; ?>" placeholder="Nama Wisata" required></td>
                                            </tr>
                                            <tr>
                                                <td><label>Latitude</label></td>
                                                <td>:</td>
                                                <td><input type="text" class="form-control" style="width:355px" name="latitude" placeholder="Latitude" autocomplete="off" required value="<?php echo $latitude; ?>"></td>
                                            </tr>
                                            <tr>
                                                <td><label>Longitude</label></td>
                                                <td>:</td>
                                                <td><input type="text" class="form-control" style="width:355px" name="longitude" placeholder="Longitude" autocomplete="off" required value="<?php echo $longitude; ?>"></td>
                                            </tr>
                                            <tr>
                                                <td><label>Alamat</label></td>
                                                <td>:</td>
                                                <td><input type="text" class="form-control" style="width:355px" name="alamat" placeholder="Alamat" autocomplete="off" required value="<?php echo $alamat; ?>"></td>
                                            </tr>                                            
                                            <tr>
                                                <td><label>Fasilitas</label></td>
                                                <td>:</td>

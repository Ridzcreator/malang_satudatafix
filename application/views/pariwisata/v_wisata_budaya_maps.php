    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url('C_wisata_budaya'); ?>">Daya Tarik Wisata Budaya</a></li>
                <li class="active">Maps Wisata Budaya </li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h4 class="box-title" style="margin-bottom: 10px">Maps Wisata Budaya Kabupaten Malang</h3><br>
                        </div>

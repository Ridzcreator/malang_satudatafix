...
<div class="content-wrapper">
    ...
    <section class="content">
        <br>
            ...
            ?>
	<div class="box table-responsive" id="tampilr" style="min-width: 10%; max-width: 90%; width: 90%; height: 100%; margin: 0 auto;">
    ...
    title: {
        text: 'Grafik Perbandingan Laporan Pengaduan Perempuan Korban Kekerasan'
    },
    subtitle: {

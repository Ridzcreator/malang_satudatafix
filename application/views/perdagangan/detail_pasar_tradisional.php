        ...
        <div class="modal-dialog">
            ...
            <table width="100%">
                    ...
                    <tr>
                        ...
                        <td style="padding:  10px">:</td>
                        <td> 
                             <select name="pengelola" class="form-control" style="width:335px;">
                                <option value="Dikelola Pemerintah">Dikelola Pemerintah</option>
                                <option value="Dikelola Swasta">Dikelola Swasta</option>
                                <option value="Dikelola Masyarakat">Dikelola Masyarakat</option>
                             </select>
                        </td>
                    </tr>
                    <tr>

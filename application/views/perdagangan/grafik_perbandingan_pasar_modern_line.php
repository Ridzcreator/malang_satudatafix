...
<?php
if($datap=="1"){
    $page="Jumlah Indomart";
}else if($datap=="2"){
    $page="Jumlah Alfamart";
}
...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
     <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Pasar Modern di Kabupaten Malang <b>
		     ...
		     <?php
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="1"){
                            $value[]=intval($a['indomart']);
                        }else if($datap=="2"){
                            $value[]=intval($a['alfamart']);
                        }
            ?>
    ...
    title: {
       text: 'Grafik Line Perbandingan Pasar Modern <?php echo $page; ?>'
    },
    subtitle: {

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Impor Negara</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <section class="content">
               ...
               <!-- /.box-header -->
                    <div class="box-header">
                        <h4 class="box-title">Tabel Jumlah Impor Menurut Negara Asal</h3>
                    </div>
            ...
            <option value="0000"> Pilih Tahun </option>
                ...
                <?php } ?>
                         ...
                         <table  class="table table-bordered table-striped" id="tampilEkspor2" style="text-align: left; font-size:15px; width: 100%;">
                <thead >
                    <tr>
                        <th style="text-align: left; vertical-align: middle;">Negara-Negara Asal</th>
                        <th style="text-align: left; vertical-align: middle;"">Volum Impor</th>
                        <th style="text-align: left; vertical-align: middle;">Nilai Impor</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel">Edit Data Impor Negara Asal</h3>
                        </div>
                        <?php echo form_open_multipart('Impor_negara_asal/proses_edit_ekspor_impor_negara') ?>
         ...
         <div id="modalHapus<?php echo $no?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3 class="modal-title" id="myModalLabel">Hapus Data Impor Negara Asal</h3>
                        </div>
                        <?php echo form_open_multipart('Impor_negara_asal/proses_hapus_ekspor_impor_negara') ?>
                        <div class="modal-body">
       ...
       <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 class="modal-title" id="myModalLabel">Tambah Data Impor Negara Asal</h3>
                            </div>
                                 <?php echo form_open_multipart('Impor_negara_asal/proses_tambah_ekspor_impor_negara') ?>
              ...
              <tr>
               ...
               <tr>
                ...
                <tr>
                        ...
                        <td style="padding:  10px">:</td>
                        <td> 
                             <input type="text" class="form-control" name="kategori"  value="Impor Menurut Negara Asal" placeholder="Tahun" autocomplete="off" readonly>
                        </td>
                    </tr>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Impor_negara_asal/tampil_grafik_negara_asal/') ?>
                    <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Impor_negara_asal/grafik_perbandingan') ?>
                    <div class="modal-body">
                    <table width="90%">
                        <tr>
                            ...
                            <option value="1">Jumlah Volume Impor</option>
                            <option value="2">Jumlah Nilai Impor</option>
                            </select></td>
                        </tr>
                        <tr>

<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Data Master Terminal<b>
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Data Master Lokasi Terminal Kabupaten Malang</h3>
		</div>
		<div class="box-body">
        <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Input Data Master Bibit</a>
		<br><br>
        <table class="table table-bordered table-striped" style="font-size:15px;"  id="tampilmasterterminal">
                <thead>
                    <tr>
						
                        <th style="text-align:center;width:10px;">No</th>
						<th style="width:450px;">Nama Terminal</th>
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        $no++;
                        $id_terminal=$a['id_terminal'];
						$keterangan=$a['nama_terminal'];
                ?>
                    <tr>
    ...
    <div id="modalEdit<?php echo $id_terminal?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('InputTerminal/proses_edit_terminal') ?>
                    ...
                    <table>
                        <tr>
                            <td><label>Nama Terminal</label></td><td>:</td>
                            <td><input name="terminal" class="form-control" type="text" value="<?php echo $keterangan;?>" placeholder="Nama Terminal..." style="width:335px;" required></td>
                        </tr>
                    </table>
                    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('InputTerminal/proses_delete_terminal') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('InputTerminal/proses_input_terminal') ?>
					...
					<table>
						<tr>
                            <td><label>Nama Terminal</label></td><td> : </td>
                            <td><input type="text" class="form-control" name="terminal" placeholder="Nama Terminal.." required></td>
						</tr>
					</table>
                    </div>
                    <div class="modal-footer">

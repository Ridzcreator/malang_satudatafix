...
<?php
if($datap=="all"){
	$page="Seluruh Data Jumlah Produksi Ikan";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah  Produksi Ikan di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url('produsiperikanan'); ?>">Jumlah Produksi Ikan  di Kabupaten Malang</a></li>
		    ...
		    <?php
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="all"){
                            $value[]=intval($a['produksi']);
                            $value1[]=intval($a['nilai_produksi']);
                        }
            ?>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Grafik Perbandingan Produksi Ikan di Kabupaten Malang'
    },
    subtitle: {

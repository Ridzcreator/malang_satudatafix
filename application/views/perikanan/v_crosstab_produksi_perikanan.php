...
<div class="content-wrapper">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Crosstab Produksi Perikanan Di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        foreach ($kecamatan->result_array() as $row4) {
        array_push($array_data_1, $row4['kecamatan']);
        array_push($array_data_2, $row4['tahun']);
        array_push($array_data_3, $row4['perikanan_laut']);
        array_push($array_data_4, $row4['perikanan_umum']);
        }

        foreach ($jumlah->result_array() as $row5) {
        array_push($array_data_8, $row5['perikanan_laut']);
        array_push($array_data_9, $row5['perikanan_umum']);
        ...
        <table class="table table-striped compact cell-border" style="font-size:13px; width:100%; text-align:center; border-color:black;" id="tampilcrostabproduksiperikanan">
                <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        for ($i=0; $i <count($array_tahun) ; $i++) { 
                            echo "
                                  <th style=\"text-align:center;\">perikanan laut</th>
                                  <th style=\"text-align:center;\">perikanan umum</th>";
                        }
                        ?>
                    </tr>
                <tbody>

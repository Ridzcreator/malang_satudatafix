...
<div class="content-wrapper">
   ...
   <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Grafik Detail Realisasi Ekspor</li>
        </ol>
    </section>
    <!-- Main content -->
...
Highcharts.chart('tampilr', {
  ...
  title: {
        text: 'Grafik Perbandingan Dan Perkembangan Realisasi Ekspor di Kabupaten Malang <?php echo $periode; ?>'
    },
    subtitle: {

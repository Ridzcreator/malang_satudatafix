...
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <h1>
            <b>Grafik Data Industri Kecil di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('Industri_kecil'); ?>">Industri Kecil</a></li>
            <li class="active">Grafik Bar Data Industri Kecil</li>
        </ol>
    </section>
    <!-- Main content -->
...
<script type="text/javascript">
    ...
    title: {
        text: 'Grafik Jenis Industri Kecil Tahun <?php echo $tahun ?>'
    },
    subtitle: {

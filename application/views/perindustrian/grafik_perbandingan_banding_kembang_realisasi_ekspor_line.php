...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Realisasi Ekspor di Kabupaten Malang<b>
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="1"){
                            ...
                            $value[]=intval($a['nilai']);
                        }else if($datap=="3"){
                            $value[]=intval($a['naik_turun']);
                        }
            ?>
    ...
    title: {
        text: 'Grafik Perbandingan Dan Perkembangan Realisasi Ekspor di Kabupaten Malang <?php echo $page; ?>'
    },
    subtitle: {

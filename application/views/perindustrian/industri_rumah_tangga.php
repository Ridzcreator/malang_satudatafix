...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>INDUSTRI RUMAH TANGGA<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Industri Rumah Tangga</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <section class="content">
               ...
               <!-- /.box-header -->
                    <div class="box-header">
                        <h4 class="box-title">Tabel Industri Rumah Tangga</h3>
                    </div>
            ...
            <option value="0000"> Pilih Tahun </option>
                ...
                <?php } ?>
                         ...
                         <table  class="table table-bordered table-striped" id="tampilRumah" style="text-align: left; font-size:15px; width: 100%;">
                <thead >
                    <tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel">Edit Data Industri Rumah Tangga</h3>
                        </div>
                        <?php echo form_open_multipart('Industri_rumah_tangga/proses_edit_industri_rumah_tangga') ?>
         ...
         <div id="modalHapus<?php echo $no?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3 class="modal-title" id="myModalLabel">Hapus Data Industri Rumah Tangga</h3>
                        </div>
                        <?php echo form_open_multipart('Industri_rumah_tangga/proses_hapus_industri_rumah_tangga') ?>
                        <div class="modal-body">
       ...
       <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 class="modal-title" id="myModalLabel">Tambah Data Industri Rumah Tangga</h3>
                            </div>
                                 <?php echo form_open_multipart('Industri_rumah_tangga/proses_tambah_industri_rumah_tangga') ?>
              ...
              <tr>
               ...
               <tr>
                ...
                <tr>
                        ...
                        <td style="padding:  10px">:</td>
                        <td> 
                             <input type="text" class="form-control" name="kategori"  value="Industri Rumah Tangga" autocomplete="off" readonly>
                        </td>
                    </tr>
                            </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Industri_rumah_tangga/tampil_grafik_industri_rumah_tangga/') ?>
                    <div class="modal-body">
    ...
    <div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Industri_rumah_tangga/grafik_perbandingan') ?>
                    <div class="modal-body">
                    <table width="90%">
                        <tr>

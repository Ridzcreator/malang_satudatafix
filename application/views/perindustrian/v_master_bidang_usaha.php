<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>KELOLA MASTER BIDANG USAHA<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Kelola Master Bidang Usaha</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Master Bidang Usaha</h3>
		</div>
		<div class="box-body">
        <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Bidang Usaha</a>
		<br><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Data Bidang Usaha</h3>
                    </div>
					...
					<table>
						<tr>
                            <td style="padding:  10px"><label>Nama Bidang Usaha</label></td>
                            <td style="padding:  10px">:</td>
                            <td style="padding:  10px"><input name="sektor" class="form-control" type="text" value="<?php echo $sktr;?>" placeholder="Password..." style="width:335px;" required></td>
						</tr>
                        <tr>
                            <td style="padding:  10px"><label>Keterangan Jenis Sektor</label></td>
                            <td style="padding:  10px">:</td>
                            <td style="padding:  10px"><input name="keterangan" class="form-control" type="text" value="<?php echo $keterangan;?>" placeholder="Password..." style="width:335px;" required></td>
                        </tr>
					</table>
                    </div>
            ...
            <div class="modal-content">
					...
					<table>
						<tr>
                            <td style="padding:  10px"><label>Nama Bidang Usaha</label></td>
                            <td style="padding:  10px"> : </td>
                            <td style="padding:  10px"><input type="text" class="form-control" name="sektor" placeholder="Keterangan" required></td>
						</tr>
                        <tr>
                            <td style="padding:  10px"><label>Keterangan Jenis Sektor</label></td>
                            <td style="padding:  10px"> : </td>
                            <td style="padding:  10px"><input type="text" class="form-control" name="keterangan" placeholder="Keterangan" required></td>
                        </tr>
					</table>
                    </div>
                    <div class="modal-footer">

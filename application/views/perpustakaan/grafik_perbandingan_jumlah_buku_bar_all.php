...
<?php
if($datap=="all"){
    $page="Seluruh Data Jumlah Koleksi Buku";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah Koleksi Buku di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('jumlahkoleksibuku'); ?>">Jumlah Jumlah Koleksi Buku di Kabupaten Malang</a></li>
            ...
            <?php
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="all"){
                            $value[]=intval($a['judul']);
                            $value1[]=intval($a['exemplar']);
                        }
            ?>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Grafik Perbandingan Data Jumlah Koleksi Buku di Kabupaten Malang'
    },
    subtitle: {

...
<?php
if($datap=="1"){
    $page="Jumlah Total smp";
}else if($datap=="2"){
    $page="Jumlah Total sma";

}else if($datap=="3"){
    $page="Jumlah Total perguruan_tinggi";
}
?>
<div class="content-wrapper">
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="1"){
                            ...
                            $value[]=intval($a['perguruan_tinggi']);
                        }
            ?>
    ...
    title: {
        text: 'Grafik Perbandingan Data Pengunjung Perpustakaan Menurut Tingkat Pendidikan di Kabupaten Malang'
    },

            ...
            <div class="col-xs-12">
               ...
               <!-- /.box-header -->
                    ...
                    <tr>
                            ...
                            <h4 class="box-title" style="margin-bottom:10px ">Jumlah Koleksi Buku Kabupaten Malang</h3><br>
                        <td>
                    ...
                    <div class="box-body">
                    <table  class="table table-striped" id="tampiljumlahkoleksibuku" width="100%" style="text-align:center">
...
<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('jumlahkoleksibuku/proses_input_jumlah_koleksi_buku') ?>

                    <div class="modal-body">
                     <table>
                      <tr>
                            <td><label>tahun</label></td><td>:</td>
                            <td>
    ...
    <div id="modalCross" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart(base_url('jumlahkoleksibuku/tampil_crosstab_jumlah_koleksi_buku')) ?>
                    <div class="modal-body">
                    <table>
...
<div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('jumlahkoleksibuku/grafik_perbandingan') ?>
                    <div class="modal-body">
                    <table>
                        <tr>
                            ...
                            <option value="1">Jumlah Total Judul</option>
                            <option value="2">Jumlah Total Exemplar</option>
                            </select></td>
                        </tr>
                        <tr>

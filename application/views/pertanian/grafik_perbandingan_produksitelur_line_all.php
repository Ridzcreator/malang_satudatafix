...
<?php
if($datap=="all"){
	$page="Seluruh Data Jumlah Usaha Peternakan";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url('C_usaha_peternakan'); ?>">Produksi Telur</a></li>
    ...
    title: {
        text: 'Grafik Perbandingan Data Produksi Telur di Kabupaten Malang'
    },
    subtitle: {

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Master Susu</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <section class="content">
                ...
                <div class="box-header">
                    <h4 class="box-title" style="margin-bottom:10px">Data Master Susu</h3><br>
                    ...
                    <div class="box-body">
                        <table  class="table table-striped" id="tampil1" width="100%" height="100%">
                            ...
                            <tbody>
                                ...
                                $no++;                                    
                                $id=$a['id'];
                                $Susu_hewan=$a['susu_hewan'];
                                ?>
                                <tr>
                                    <td style="text-align:center"><?php echo $no;?></td>
                        <!--             <td style="text-align:center"><?php echo $id;?></td> -->
                                    <td style="text-align:center"><?php echo $Susu_hewan;?></td>
                        ...
                        <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <?php echo form_open_multipart('C_master_susu/tambah_data') ?>
            ...
            <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                                ...
                                <?php echo form_open_multipart('C_master_susu/ubah_data') ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <tr>
                                        <td><label>Nama Hewan</label></td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control" name="nama_hewan" style="width:355px"  value="<?php echo $Susu_hewan;?>" required></td>
                                    </tr>
            ...
            <div id="modalHapus<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open_multipart('C_master_susu/hapus_data') ?>
                        <div class="modal-body">

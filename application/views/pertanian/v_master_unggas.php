...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Master Unggas</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <section class="content">
                ...
                <div class="box-header">
                    <h4 class="box-title" style="margin-bottom:10px">Data Master Unggas</h3><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <!--    <td style="text-align:center"><?php echo $id;?></td> -->
                                    <td style="text-align:center"><?php echo $nama_unggas;?></td>
                        ...
                        <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <?php echo form_open_multipart('C_master_unggas/tambah_data') ?>
            ...
            <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                                ...
                                <?php echo form_open_multipart('C_master_unggas/ubah_data') ?>
                                ...
                                <div class="modal-body">
                                    ...
                                    <tr>
                                        <td><label>Nama Hewan</label></td>
                                        <td>:</td>
                                        <td><input type="text" class="form-control" name="nama_hewan" style="width:355px"  value="<?php echo $nama_unggas;?>" required></td>
                                    </tr>
            ...
            <div id="modalHapus<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open_multipart('C_master_unggas/hapus_data') ?>
                        <div class="modal-body">

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Produksi Susu</li>
        </ol>
    <!-- Main content -->
    ...
    <section class="content">
               ...
               <!-- /.box-header -->
                    <div class="box-header">
                        <h4 class="box-title">Tabel Produksi Susu</h3>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <table  class="table table-bordered table-striped" id="tampilSusu" style="text-align: center; font-size:15px; width: 100%;">
                <thead >
                    <tr>
                        <th style="text-align: center; vertical-align: middle;">Jenis Produksi (Susu)</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="myModalLabel">Edit Data Produksi Susu</h3>
                        </div>
                        <?php echo form_open_multipart('C_produksi_susu/proses_edit_produksi_susu') ?>
                        ...
                        <table >
                            <tr>
                              <td  ><label>Jenis Susu Hewan</label></td>
                              <td>:</td>
                              <td><input type="text" class="form-control" style="width:355px" name="jenis_susu_hewan" value="<?php echo $jenis_susu_hewan;?>" required readonly></td>
                            </tr>
                            <tr>
                               <td  ><label>Satuan</label></td>
                               <td>:</td>
                               <td><input type="text" class="form-control" style="width:355px" name="satuan" value="<?php echo $satuan;?>" required readonly></td>
                            </tr>
                            <tr>
                               <td  ><label>Total Produksi</label></td>
                               <td>:</td>
                               <td><input type="number" min="0" step="0.01" style="width:355px" class="form-control" name="total_produksi" value="<?php echo $total_produksi;?>" required></td>
                            </tr>
                            <tr>
                                <td  ><label>Tahun</label></td>
                                <td>:</td>
                                <td><input type="number" class="form-control" style="width:355px" name="tahun"  value="<?php echo $tahun;?>" placeholder="Tahun" autocomplete="off" readonly></td>
                            </tr>
                        </table>
                        </div>
         ...
         <div id="modalHapus<?php echo $no?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3 class="modal-title" id="myModalLabel">Hapus Data Produksi Susu</h3>
                        </div>
                        <?php echo form_open_multipart('C_produksi_susu/proses_hapus_produksi_susu') ?>
                        <div class="modal-body">
       ...
       <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 class="modal-title" id="myModalLabel">Tambah Data Produksi Susu</h3>
                            </div>
                                 <?php echo form_open_multipart('C_produksi_susu/proses_tambah_produksi_susu') ?>
                    <div class="modal-body">
                           <table>
                              <tr>
                               <td  ><label>Jenis Susu Hewan</label></td>
                               <td  >:</td>
                               <td> 
                                <select name="jenis_susu_hewan" class="form-control">
                                   <?php foreach ($datas->result() as $a) {
                                    ?>
                                    <option value="<?php echo $a->susu_hewan ?>"><?php echo $a->susu_hewan ?></option>
                                    <?php
                                }
                                ?>
                                </select>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('C_produksi_susu/tampil_produksi_susu/') ?>
                    <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart(base_url('C_produksi_susu/tampil_crosstab_produksi_susu')) ?>
                    <div class="modal-body">
                    <table>

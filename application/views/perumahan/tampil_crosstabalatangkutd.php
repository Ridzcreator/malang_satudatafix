...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Data Alat Angkut Sampah <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url('Alatangkutd'); ?>"> Data Alat Angkut Sampah</a></li>
            <li class="active"> Crosstab Data Alat Angkut Sampah</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Alat Angkut Sampah  Tiap Tahun di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center;" id="tampil_crosstab_alatangkutd">
                <thead>
                <tr>
                 <th rowspan=2 style="text-align: center; padding-bottom: 20px;">Alat Angkut</th>

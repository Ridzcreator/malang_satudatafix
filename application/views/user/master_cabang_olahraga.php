<div class="content-wrapper">
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Kelola Data Cabang Olahraga</h3>
		</div>
		<div class="box-body">
        <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Cabang Olahraga</a>
		<br><br>
        <table class="table table-bordered table-striped" style="font-size:15px; font-family:"Courier New""  id="tampil1">
                <thead>
                    <tr>
                     ...
                     <!--    <th style="text-align:center;">Id Cabang Olahraga</th> -->
						<th style="">Nama Cabang Olahraga</th>
    ...
    <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('C_master_cabangolahraga/proses_edit_master_cabang') ?>

                    <div class="modal-body">
					<input class="form-control" type="hidden" name="id" value="<?php echo $id;?>" placeholder="Id..." style="width:335px;" readonly hidden>
					<table>
						<tr>
                            <td style="padding: 10px"><label>Nama Cabang Olahraga</label></td><td>:</td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('C_master_cabangolahraga/proses_delete_master_cabang') ?>
            <div class="modal-body">

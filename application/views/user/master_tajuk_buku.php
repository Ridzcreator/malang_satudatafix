...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Master Tajuk Buku<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Master Tajuk Buku</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Master Tajuk Buku Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
            <td>
            <a style="margin-right: 10px" class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Tajuk Buku</a>
            </td>
        </tr>
        </table>
    <table class="table table-bordered table-striped compact cell-border" style="font-size:15px; width:100%;  text-align:center" id="tampiltajukbuku">
                <thead>
                    <tr>
                        <th style="text-align:center;text-align:center;width:50px;">No</th>
                        <th style="text-align:center;text-align:center;width:50px;" >Tajuk Buku</td>
                ...
                <div class="modal-header">
                    ...
                    <table>
                       <tr>
                            ...
                            <td style="padding:  10px"><input name="tajuk_buku" class="form-control" value="<?php echo $tb;?>" style="width:335px;" required></td>
                        </tr>
     ...
     <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="modal-title" id="myModalLabel">Tambah Data Master Tajuk Buku</h3>
                    </div>
                    <?php echo form_open_multipart('master_tajukbuku/proses_input_tajuk_buku') ?>
                    ...
                    <table>
                             ...
                             <tr>
                            <td style="padding:  10px"><label>Tajuk Buku</label></td><td>:</td>
                            <td style="padding:  10px"><input name="tajuk_buku" class="form-control" type="text" placeholder=" " style="width:335px;" required autocomplete="off"></td>
                        </tr>

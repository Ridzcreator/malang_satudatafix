...
class Dashboard extends CI_Controller
{
  ...
  public function index()
  {
    ...
    //grafik dinas pariwisata wisatawan datang
    $this->load->model('m_dasboard_grafik_wisatawan_datang', 'wisatawan_datang', true);
    $data['grafik_dinas_pariwisata_wisata_datang'] = $this->wisatawan_datang->tampil_grafik_wisatawan_datang();

    //grafik dinas pariwisata wisatawan menginap
    $this->load->model('m_dasboard_grafik_wisatawan_menginap', 'wisatawan_menginap', true);
    $data['grafik_dinas_pariwisata_wisata_menginap'] = $this->wisatawan_menginap->tampil_grafik_wisatawan_menginap();

    //grafik jumlah wisata budaya
    $this->load->model('m_warisan_budaya', 'jumlah_warisan_budaya', true);
    $data['grafik_jumlah_warisan_budaya'] = $this->jumlah_warisan_budaya->tampil_data();

...
<?php
    ...
    $page="Seluruh Data Jumlah Banyak Bencana";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah Banyak Bencana di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('Banyakbencana'); ?>">Jumlah Banyak Bencana di Kabupaten Malang</a></li>
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        $periode[]=intval($a['periode']);
                            ...
                            $value1[]=intval($a['jumlah_korban']);
                            $value2[]=intval($a['hancur']);
                            $value3[]=intval($a['rusak']);
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Grafik Perbandingan Data Banyak Bencana di Kabupaten Malang'
    },
    subtitle: {

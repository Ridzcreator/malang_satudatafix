...
<div class="content-wrapper">
    ...
    <div class="box">
        ...
        foreach ($kecamatan->result_array() as $row2) {
            ...
            array_push($array_kecamatan, $row2['nama_kecamatan']);
        }
        ...
        array_push($array_data_2, $row4['kebakaran']);
        array_push($array_data_3, $row4['korban_manusia']);
        array_push($array_data_4, $row4['periode']);
        }

        foreach ($jumlah->result_array() as $row5) {
        array_push($array_data_5, $row5['kebakaran']);
        array_push($array_data_6, $row5['korban_manusia']);
        ...
        <table class="table table-bordered table-striped compact cell-border" style="font-size:15px; width:100%; text-align:center;" id="tampilDetailCrosstabKebakaran">
                <thead>
                   <tr>
                ...
                <?php 
                for ($i=0; $i <count($array_tahun) ; $i++) { 
                    echo "<th style=\"text-align:center;\">Kebakaran</th>
                          <th style=\"text-align:center;\">Jumlah Korban</th>";
                }
                ?>
            </tr>
                <tbody>

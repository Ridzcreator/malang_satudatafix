...
<div class="content-wrapper">
   ...
   <section class="content">
    <div class="box">
        ...
        <table class="table table-bordered table-striped compact cell-border" style="font-size:15px; width:100%; text-align:center"  id="tampildetail">
                <thead>
                    <tr>
                        <th style="text-align:center;width:5%;vertical-align:middle" >No</th> 
                        <th style="text-align:center;width:10%;vertical-align:middle" >Unjukrasa</th>
    ...
    <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Unjukrasa/proses_edit_unjukrasa/'.$this->uri->segment(3)) ?>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Detail Pelanggan PDAM</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
               ...
               <!-- /.box-header -->
                    ...
                    <?php $page=$this->uri->segment(3); ?>
                         ...
                         <h4 class="box-title" style="margin-bottom:10px ">Detail Jumlah Pelanggan PDAM Menurut Kecamatan Di Kabupaten Malang</h3><br>
                    <table>
                    <tr>
                     ...
                     <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<?php echo form_open_multipart('C_pelanggan_pdam/tambah_detail_pdam/'.$page) ?>
                ...
                <div id="modalHapus<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <?php echo form_open_multipart('C_pelanggan_pdam/proses_hapus_pdam/'.$page) ?>
                            <div class="modal-body">
                ...
                <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                                    ...
                                    <?php echo form_open_multipart('C_pelanggan_pdam/ubah_pdam/'.$page) ?>

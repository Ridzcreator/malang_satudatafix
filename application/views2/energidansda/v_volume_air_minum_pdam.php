            ...
            <div class="col-xs-12">
               ...
               <!-- /.box-header -->
               		<div class="box-header">
			                ...
			                <h4 class="box-title" style="margin-bottom:10px ">Volume Air Minum PDAM Menurut Bulan Di Kabupaten Malang</h3>
			            <table>
			            <tr>
	                ...
	                <div class="box-body">
			            ...
			            <table  class="table table-striped" id="tampilAirPDAM" width="100%" style="text-align:center; font-size:15px">
			                <thead >
		            ...
		            <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<?php echo form_open_multipart('C_volume_air_minum_pdam/tambah_data') ?>
						...
						<div id="modalCross" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
					        <div class="modal-dialog">
					            <div class="modal-content">
					                    ...
					                    <?php echo form_open_multipart(base_url('C_volume_air_minum_pdam/tampil_crosstab_pdam')) ?>
					                    <div class="modal-body">
					                    <table>
					    ...
					    <div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
					        <div class="modal-dialog">
					            <div class="modal-content">
										...
										<?php echo form_open_multipart('C_volume_air_minum_pdam/grafik_perbandingan') ?>
										<div class="modal-body">
										<table>
											<tr>

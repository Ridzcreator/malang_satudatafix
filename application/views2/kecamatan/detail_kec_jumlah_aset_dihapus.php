   ...
   <section class="content-header">
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Detail Tabel Jumlah Aset Yang Dihapus di Kabupaten Malang</h3>
        </div>
       ...
       <table>
        <tr>
            ...
            <td>
                 <a class="btn btn-success" href="../grafik_jumlah_aset_dihapus/<?php echo $periodee?>">Lihat Grafik</a>
            </td>
        </tr>
        </table>
       </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Jumlah Aset Dihapus</h3>
                    </div>
                    <?php echo form_open_multipart($idx.'/proses_edit_jumlah_aset_dihapus/'.$periodee) ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart($idx.'/proses_delete_jumlah_aset_dihapus/'.$periodee) ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_detail_jumlah_aset_dihapus/'.$periodee) ?>

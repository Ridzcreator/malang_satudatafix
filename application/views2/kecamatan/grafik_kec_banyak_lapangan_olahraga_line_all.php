...
<body>
<?php
	$page="Semua Data Banyak Lapangan Olahraga Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Banyak Lapangan Olahraga<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i> Banyak Lapangan Olahraga</a></li>
    ...
    title: {
        text: 'Perbandingan Data Lapangan Olahraga'
    },
    subtitle: {

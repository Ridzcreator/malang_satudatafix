...
<body>
<?php
	$page="Semua Data Banyak Prestasi Yang Diraih Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Banyak Prestasi Yang Diraih<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i> Banyak Prestasi Yang Diraih</a></li>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Perbandingan Data Prestasi Yang Diraih'
    },
    subtitle: {

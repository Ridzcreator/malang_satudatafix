...
<body>
<?php
    $page="Semua Data Jaminan Kesehatan Masyarakat Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Jaminan Kesehatan Masyarakat<b>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Perbandingan Data Penduduk Terfasilitasi Jaminan Kesehatan Masyarakat'
    },
    subtitle: {

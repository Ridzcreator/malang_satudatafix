...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Jumlah Nominal Aset<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= base_url($idx); ?>"></i> Jumlah Nominal Aset Yang Dihapus </a></li>
    ...
    title: {
        text: 'Perbandingan Data Jumlah Nominal Aset Yang Dihapus '
    },
    subtitle: {
    ...
    series: [{
        name: 'Jumlah Nominal Aset Yang Dihapus ',

...
<body>
<?php
	$page="Jumlah Aset Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url($idx); ?>"></i> Jumlah Nominal Aset</a></li>
    ...
    title: {
        text: 'Perbandingan Data Jumlah Nominal Aset'
    },
    subtitle: {

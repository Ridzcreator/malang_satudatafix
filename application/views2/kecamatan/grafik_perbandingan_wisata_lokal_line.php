...
<body>
<?php
	$page="Jumlah Seluruh Jumlah Penduduk Berdasarkan Agama Kecamatan ".$kecamatan;
?>
<div class="content-wrapper">
    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Jumlah Penduduk Berdasarkan Agama<b>
    ...
    title: {
        text: 'Perbandingan Data Jumlah Penduduk Berdasarkan Agama'
    },
    subtitle: {

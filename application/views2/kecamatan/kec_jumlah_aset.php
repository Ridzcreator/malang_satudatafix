...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Jumlah Aset</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Tabel Jumlah Aset di Kab. Malang</h3>			
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%;  text-align:center"  id="tampil_jumlah_aset">
                <thead>
                    <tr>
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_jumlah_aset') ?>

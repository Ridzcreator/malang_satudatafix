...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>JUMLAH ASET DIHAPUS<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Jumlah Aset Dihapus</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Tabel Jumlah Aset Dihapus di Kab. Malang</h3>			
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%;  text-align:center"  id="tampil_jumlah_aset_dihapus">
                <thead>
                    <tr>
                        <th style="text-align:center;width:1%;">No</th>
						<th style="text-align:center;width:25%;">Jumlah Aset</th>
						<th style="text-align:center;width:25%;">Jumlah Nominal</th>
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_jumlah_aset_dihapus') ?>
            ...
            <div class="modal-content">
					...
					<table>
						<tr>
							...
							<option value="all">Data Jumlah Aset</option>
							<option value="jumlah">Data Jumlah Nominal</option>
							</select></td>
						</tr>
						<tr>

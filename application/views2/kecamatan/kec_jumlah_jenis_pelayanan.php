...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Jumlah Jenis Pelayanan</li>
        </ol>
    </section>
    <!-- Main content -->
	...
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">Tabel Jumlah Jenis Pelayanan di Kab. Malang</h3>			
        </div>
        ...
        <table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%;  text-align:center"  id="tampil_jumlah_jenis_pelayanan">
                <thead>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart($idx.'/proses_input_jumlah_jenis_pelayanan') ?>
            ...
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Tampilan Report</h3>
                   		...
                   		<?php echo form_open_multipart($idx.'/tampil_crosstab_jumlah_jenis_pelayanan') ?>
                    <div class="modal-body">
                    <table>

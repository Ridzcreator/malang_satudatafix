...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url($idx); ?>"> Data Banyak Lapangan Olahraga</a></li>
            <li class="active"> Crosstab Data Banyak Lapangan Olahraga Kecamatan <?php echo $kecamatan;?></li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Data Banyak Lapangan Olahraga Kecamatan <?php echo $kecamatan;?> Tiap Tahun di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>

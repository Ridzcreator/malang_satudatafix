...
<?php
if($datap=="all"){
	$page="Seluruh Data Jumlah Tower";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah Tower di Kabupaten Malang <b>
    ...
    title: {
        text: 'Grafik Perbandingan Data Jumlah Tower di Kabupaten Malang'
    },
    subtitle: {

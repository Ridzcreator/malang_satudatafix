<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Rumah Sakit Terhubung di Kabupaten Malang<b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('internetkecamatan'); ?>"></i> Rumah Sakit Terhubung di Kabupaten Malang</a></li>
            <li class="active">Rumah Sakit Terhubung di Kabupaten Malang</li>
        </ol>
    </section>
    <!-- Main content -->

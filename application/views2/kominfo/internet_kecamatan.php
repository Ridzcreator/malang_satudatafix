...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Akses Internet Di Kantor Kecamatan  <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Akses Internet Di Kantor Kecamatann</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Tabel Akses Internet Di Kantor Kecamatan</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
    ...
    <table class="table table-bordered table-striped compact cell-border" style="font-size:15px; width:100%;  text-align:center" id="tampilinternetkecamatan">
                <thead>
                    <tr>
                        <th style="vertical-align:middle; text-align:left;"  >No</th>
                        <th style="vertical-align:middle; text-align:left;" >Kantor Kecamatan</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="myModalLabel">Edit Akses Internet Di Kecamatan</h3>
                </div>
                    <?php echo form_open_multipart('internetkecamatan/proses_edit_internet_kecamatan') ?>
                       ...
                       <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td style="padding:  10px"><input name="operator_penyedia" class="form-control" value="<?php echo $op;?>" style="width:335px;" required autocomplete="off"></td>
                        </tr>
...
<div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('internetkecamatan/tampil_grafik_kec/') ?>
                    <div class="modal-body">           
                <table width="90%">
                    <tr>
...
<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 class="modal-title" id="myModalLabel">Tambah Data Akses Internet Di Kecamatan</h3>
                    </div>
                    <?php echo form_open_multipart('internetkecamatan/proses_input_internet_kecamatan') ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <?php echo form_open_multipart('internetkecamatan/proses_hapus_internet_kecamatan') ?>
                        <div class="modal-body">

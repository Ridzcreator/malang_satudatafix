<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Laporan Masuk</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <section class="content">
        ...
        <div class="box-header">
            <h3 class="box-title">Tabel Jumlah Pengaduan atau Laporan Masuk di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
                ...
                <?php } ?>
		            ...
		            <table  class="table table-striped" id="tampilprasarana" width="100%" style="text-align:center">
		                <thead>
                                    ...
                                    <th style="text-align:center; vertical-align: middle;">Surat Warga</th>
                                    <th style="text-align:center; vertical-align: middle;">PPID</th>
...
<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        ...
        <table width="90%">
                        ...
                        <tr>
                            ...
                            <td style="padding:  10px"><select name="kecamatan" id="kecamatan" class="form-control"  required>

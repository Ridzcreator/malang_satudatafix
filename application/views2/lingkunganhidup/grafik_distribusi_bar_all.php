...
<?php
    ...
    $page="Distribusi Bibit Tanaman di Malang";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Jumlah Distribusi Bibit Tanaman di Malang<b>
    ...
    title: {
        text: 'Distribusi Bibit Tanaman di Malang Tiap Tahun di Kabupaten Malang'
    },
    subtitle: {
    ...
    series: [
    <?php 
    $arrlength1 = count($array_bibit);
    for ($i=0; $i < $arrlength1; $i++) { ?>
    {
        <?php echo "name :".json_encode($array_bibit[$i]) ?> ,
        <?php echo "data: [";

...
<?php
if($datap=="1"){
	$page="Jumlah Pencemaran Tanah";
}else if($datap=="2"){
	$page="Jumlah Pencemaran Air";
}else if($datap=="3"){
	$page="Jumlah Pencemaran Udara";
}
...
<div class="content-wrapper">
				...
				$value=array();
                    foreach ($data->result_array() as $a) {
						...
						if($datap=="1"){
							...
							$value[]=intval($a['jumlah_pencemaran_air']);
						}else if($datap=="3"){
							$value[]=intval($a['jumlah_pencemaran_udara']);
						}
            ?>
    ...
    title: {
        text: 'Grafik Perbandingan Lokasi Pencemaran di Kabupaten Malang <?php echo $page; ?>'
    },
    subtitle: {

...
<?php
if($datap=="all"){
	$page="Seluruh Data Jumlah Laporan Pengaduan Korban Kekerasan";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url('Pengaduanper'); ?>">Laporan Pengaduan Korban Kekerasan</a></li>
    ...
    title: {
        text: 'Grafik Perbandingan Laporan Pengaduan Korban Kekerasan'
    },
    subtitle: {

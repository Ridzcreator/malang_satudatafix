    ...
    <!-- Content Header (Page header) -->
      <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Detail Pasar Tradisional Masyarakat</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="modal-dialog">
            ...
            <table width="80%">
                    ...
                    <tr>
                        ...
                        <td style="padding:  10px">:</td>
                        <td> 
                             <input type="text" class="form-control" name="pengelola"  value="Dikelola Masyarakat" autocomplete="off" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:  10px"><label>Nama Pengelola</label></td>

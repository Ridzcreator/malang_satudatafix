...
<div class="content-wrapper">
    ...
    <div class="box">
       ...
       <table class="table table-bordered table-striped compact cell-border" style="font-size:15px;  text-align:center" id="tampil_banyak_kendaraan">
                <thead>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Banyakkendaraan/proses_input_kendaraan') ?>
   ...
   <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Banyakkendaraan/proses_edit_kendaraan') ?>
                    <div class="modal-body">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('Banyakkendaraan/proses_delete_kendaraan') ?>
            <div class="modal-body">
    ...
    <div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Banyakkendaraan/grafik_perbandinganx') ?>
                    <div class="modal-body">
                    <table>
                        <tr>
                            ...
                            <option value="mpu">Data MPU</option>
                            <option value="bus">Data Bus</option>
                            <option value="barang">Data Mobil Barang</option>
                            <option value="gandeng">Data Kereta Gandeng</option>
                            <option value="tempel">Data Kereta Tempel</option>
                            <option value="khusus">Data Kendaraan Khusus</option>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">NIlai Produksi Ikan Tawar</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Jumlah Nilai Produksi Ikan Tawar Menurut Kecamatan Di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        array_push($array_data_3, $row4['nilai_produksi']);
        }

        foreach ($jumlahp->result_array() as $row5) {
        array_push($array_data_8, $row5['nilai_produksi']);
          ...
          <table class="table table-striped compact cell-border" style="font-size:13px; width:100%; text-align:center; border-color:black;" id="tampilcrostabproduksiikan">
                <thead>
                    ...
                    <tr>
                        <?php 
                        for ($i=0; $i <count($array_tahun) ; $i++) { 
                            echo "<th style=\"text-align:center;\">nilai produksi</th>";
                        }
                        ?>
                    </tr>
                <tbody>

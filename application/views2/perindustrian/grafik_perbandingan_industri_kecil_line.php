...
<?php
if($datap=="1"){
    $page="Total Jumlah Unit Produksi";
}else if($datap=="2"){
    $page="Total Jumlah Tenaga Kerja";
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Industri Kecil di Kabupaten Malang <b>
            <small>KABUPATEN MALANG SATU DATA</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?= base_url('Industri_kecil'); ?>">Industri Kecil</a></li>
                ...
                $value=array();
                    foreach ($data->result_array() as $a) {
                        ...
                        if($datap=="1"){
                            ...
                            $value[]=intval($a['jumlah_tenaga_kerja']);
                        }
            ?>
    ...
    Highcharts.chart('tampilr', {
     ...
     title: {
        text: 'Grafik Line Industri Kecil di Kabupaten Malang <?php echo $page; ?>'
    },
    subtitle: {

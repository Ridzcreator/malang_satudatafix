...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Jumlah Perusahaan menurut Klasifikasi Industri di Kabupaten Malang <b>
...
Klasifikasi</a></li>
    ...
    <section class="content">
        ...
        ?>
	<div class="box" id="tampilr" style="min-width: 10%; max-width: 100%; height: 100%; margin: 0 auto;">
    ...
    title: {
        text: 'Grafik Bar Data Jumlah Perusahaan menurut Klasifikasi Industri di Kabupaten Malang <?php echo $page; ?>'
    },
    subtitle: {

...
<?php
if($datap=="all"){
	$page="Seluruh Data Pengunjung Perpustakaan menurut Jenis Kelamin";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Grafik Perbandingan Data Pengunjung Perpustakaan menurut Jenis Kelamin Menginap di Kabupaten Malang <b>
...
Highcharts.chart('tampilr', {
    ...
    title: {
        text: 'Grafik Perbandingan DataPengunjung Perpustakaan Jenis Kelamin di Kabupaten Malang'
    },
    subtitle: {

...
<?php
if($datap=="all"){
	$page="Seluruh Data Pengunjung Perpustakaan menurut Status Pekerjaan";
}
?>
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
			...
			<li><a href="<?= base_url('pengunjungperpusspekerjaan'); ?>">Pengunjung Perpustakaan menurut Status Pekerjaan di Kabupaten Malang</a></li>
				...
				$value=array();
                    foreach ($data->result_array() as $a) {
						...
						if($datap=="all"){
							...
							$value1[]=intval($a['pelajar']);
                            $value2[]=intval($a['karyawan']);
						}
            ?>

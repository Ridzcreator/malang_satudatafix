...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Pengunjung Perpustakaan Berdasarkan Jenis Kelamin</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               <!-- /.box-header -->
                    ...
                    <tr>
                        <td>
                            <h4 class="box-title" style="margin-bottom:10px ">Pengunjung Perpustakaan Berdasarkan Jenis Kelamin Kabupaten Malang</h3><br>
                        <td>
                    ...
                    <div class="box-body">
                    <table  class="table table-striped" id="tampilpengunjungperpusjkel" width="100%" style="text-align:center">
                       <thead>
                    <tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="modal-title" id="myModalLabel">Tambah Data Perpustakaan Jenis Kelamin</h3>
                                    </div>


                                    <?php echo form_open_multipart('pengunjungperpusjkel/proses_input_pengunjung_perpus_jkel') ?>
...
<div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('pengunjungperpusjkel/grafik_perbandingan') ?>
                    <div class="modal-body">
                    <table>
                        <tr>
                            ...
                            <option value="1">Jumlah Total Laki-Laki</option>
                            <option value="2">Jumlah Total Perempuan</option>
                            </select></td>
                        </tr>
                        <tr>

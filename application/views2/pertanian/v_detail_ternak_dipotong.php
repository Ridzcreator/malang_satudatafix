                                        ...
                                        <input class="form-control" type="hidden" name="id" readonly>
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><input type="text" value="<?php echo $kcmtn; ?>" class="form-control" style="width:335px;" name="kecamatan" placeholder="kecamatan" required readonly autocomplete="off"></td>
                                                </tr>
                                                <tr>

<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Jumlah Ternak Dipotong</li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <?php $page = $this->uri->segment(3);  ?>
            ...
            <?php
                foreach ($data->result_array() as $a) {
                    $id=$a['id'];
                    $tahun[]=$a['tahun'];
                    $sapi_perah[]=intval($a['sapi_perah']);
                    $sapi_potong[]=intval($a['sapi_potong']);
                    $kerbau[]=intval($a['kerbau']);
                    $kuda[]=intval($a['kuda']);
                    $Kambing[]=intval($a['kambing']);
                    $Domba[]=intval($a['domba']);
                    $Kelinci[]=intval($a['kelinci']);
                    $Babi[]=intval($a['babi']);
...
<script type="text/javascript">
    ...
    title: {
        text: 'Jumlah Ternak Dipotong Di Kabupaten Malang Tahun <?php echo $page?>'
    },
    subtitle: {
    ...
    series: [
        {
            ...
            data: [
                {
                    name: "Sapi Perah",
                    y: <?php echo json_encode($sapi_perah); ?>,
                },
                {
                    name: "Firefox",
                    y: 10.57,

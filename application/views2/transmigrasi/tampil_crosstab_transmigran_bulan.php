...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Crosstab Data Pemberangkatan Transmigran Menurut Bulan</li>
        </ol>
    </section>
    <!-- Main content -->
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Banyaknya Pemberangkatan Transmigran Menurut Bulan di Kabupaten Malang</h3>
        </div>
        <div class="box-body">
        <table>
        <tr>
        ...
        foreach ($bulan->result_array() as $row2) {
            ...
            array_push($array_bulan, $row2['keterangan']);
        }
        ...
        for ($i=0; $i < count($array_bulan) ; $i++) { 
            for ($j=0; $j < (count($array_tahun)) ; $j++) { 
                ...
                for ($x=0; $x < count($array_data_1) ; $x++) { 
                    if ($array_bulan[$i]==$array_data_1[$x]&& $array_tahun[$j]==$array_data_4[$x]) {
        ...
        <table class="table table-bordered table-striped" style="font-size:15px; width:100%; text-align:center;" id="tampilDetailCrosstabTraBulan">
                <thead>
                   <tr>
                ...
                <?php
                    for ($i=0; $i <count($array_bulan); $i++) { 
                    echo "<tr>";
                    echo "<td style='text-align: left;'>".$array_bulan[$i]."</td>";
                    for ($j=0; $j < (count($array_tahun)); $j++) { 

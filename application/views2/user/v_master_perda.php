...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <b>Kelola Data Kantor Perangkat Daerah di Kabupaten Malang<b>
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Kantor Perangkat Daerah di Kabupaten Malang</h3>
		</div>
		<div class="box-body">
        <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Perda</a>
		<br><br>
        <table class="table table-bordered table-striped" style="font-size:15px;"  id="tampil1">
                <thead>
                    <tr>
    ...
    <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('C_master_perda/proses_edit_master_perda') ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('C_master_perda/proses_delete_master_perda') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('C_master_perda/proses_input_master_perda') ?>

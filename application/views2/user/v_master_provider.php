<div class="content-wrapper">
	...
	<div class="box">
        <div class="box-header">
			<h3 class="box-title">Tabel Data Provider</h3>
		</div>
		<div class="box-body">
        <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Provider</a>
		<br><br>
        <table class="table table-bordered table-striped" style="font-size:15px; font-family:"Courier New""  id="tampil1">
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        $no++;
                        $id=$a['id'];
						$keterangan=$a['operator_penyedia'];
                ?>
                    <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Update Data provider</h3>
                    </div>
                    <?php echo form_open_multipart('C_master_provider/proses_edit_master_provider') ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php echo form_open_multipart('C_master_provider/proses_delete_master_provider') ?>
            <div class="modal-body">
	...
	<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('C_master_provider/proses_input_master_provider') ?>
